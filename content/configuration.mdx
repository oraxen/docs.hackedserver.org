...
HackedServer 3.12.1 introduces deep Lunar Client integration via the Apollo protocol. This enables detection of all mods installed through Lunar Client, including their versions and types.
