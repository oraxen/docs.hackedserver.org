...
HackedServer works on all versions of Spigot from 1.8 and even supports different forks of Spigot like [PaperMC](https://papermc.io/), [TacoSpigot](https://tacospigot.github.io/) or [Akarin](https://github.com/Akarin-project/Akarin), just follow the instructions in the [dedicated section](/index#installing-hackedserver-on-spigot).
...
If you are using a proxy like bungeecord you need to install HackedServer.jar in the proxy plugins folder too in order to fix forge mods detection, follow the instructions in [this section](/index#installing-hackedserver-on-bungeecord).
